...
module.exports = {
  ...
  onStart: async ({ api, message ,event }) => {
        try {
            ...
            const botPrefix = "?";
            const authorName = "Noman Khan";
            const ownAge = "18";
            const teamName = "Bot Team";
      const authorFB = "https://www.facebook.com/noman.yime?mibextid=ZbWKwL";
          const authorInsta = "_rakibul_38_92";
  const link = "https://i.imgur.com/9N16waO.jpeg";
